 ...
 * 
 */
@WebServiceClient(name = "CalculadoraImplService", targetNamespace = "http://ejemplojaxws.formacion.ipartek.com/", wsdlLocation = "http://localhost:8080/calculadora?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULADORAIMPLSERVICE_QNAME = new QName("http://ejemplojaxws.formacion.ipartek.com/", "CalculadoraImplService");
    ...
    public CalculadoraImpl getCalculadoraImplPort() {
        return super.getPort(new QName("http://ejemplojaxws.formacion.ipartek.com/", "CalculadoraImplPort"), CalculadoraImpl.class);
    }
    ...
    public CalculadoraImpl getCalculadoraImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ejemplojaxws.formacion.ipartek.com/", "CalculadoraImplPort"), CalculadoraImpl.class, features);
    }
