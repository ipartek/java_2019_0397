...
public class Alumno {
	...
	public void setNombre(String nombre) {
		...
		if(!nombre.matches(REGEX_NOMBRE) ) {
			throw new EntidadesException("Sólo se admiten caracteres de letras y espacios");
		}
	...
	public void setApellidos(String apellidos) {
		...
		if(!apellidos.matches(REGEX_APELLIDOS)) {
			throw new EntidadesException("Los apellidos deben ser letras, espacios y/o apóstrofes");
		}
	...
	public void setDni(String dni) {
		...
		if(!Biblioteca.dniValido(dni)) {
			throw new EntidadesException("El DNI introducido no es válido");
		}
